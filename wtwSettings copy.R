...
LP = 1 - (1 + k * (trialGapValues$LP / 6 - mu) / sigma) ^ (-1 / k)
...
# rewardRate
HP = (tokenValue * rewardDelayCDF$HP + loseValue * (1 - rewardDelayCDF$HP))/
  ((meanRewardDelay$HP * rewardDelayCDF$HP + trialGapValues$HP * (1 - rewardDelayCDF$HP)) + iti)
LP = (tokenValue * rewardDelayCDF$LP  + loseValue * (1 - rewardDelayCDF$LP))/
